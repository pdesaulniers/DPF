...
typedef enum {
    ...
    PUGL_VK_Minus = 45,
    PUGL_VK_Equals = 46,
    PUGL_VK_LeftBracket = 47,
    PUGL_VK_RightBracket = 48,
    PUGL_VK_Backslash = 49,
    PUGL_VK_Semicolon = 51,
    PUGL_VK_Quote = 52,
    PUGL_VK_Grave = 53,
    PUGL_VK_Comma = 54,
    PUGL_VK_Period = 55,
    ...
    PUGL_VK_F11 = 68,
    PUGL_VK_F12 = 69,
    PUGL_VK_PrintScreen = 70,
    PUGL_VK_ScrollLock = 71,
    PUGL_VK_Pause = 72,
    PUGL_VK_Insert = 73,
    PUGL_VK_Home = 74,
    PUGL_VK_PageUp = 75,
    PUGL_VK_DeleteForward = 76,
    PUGL_VK_End = 77,
    PUGL_VK_PageDown = 78,
    PUGL_VK_Right = 79,
    PUGL_VK_Left = 80,
    PUGL_VK_Down = 81,
    PUGL_VK_Up = 82,
    PUGL_VK_KP_NumLock = 83,
    PUGL_VK_KP_Divide = 84,
    PUGL_VK_KP_Multiply = 85,
    PUGL_VK_KP_Subtract = 86,
    PUGL_VK_KP_Add = 87,
    PUGL_VK_KP_Enter = 88,
    PUGL_VK_KP_1 = 89,
    PUGL_VK_KP_2 = 90,
    ...
    PUGL_VK_KP_0 = 98,
    PUGL_VKPoint = 99,
    PUGL_VK_NonUSBackslash = 100,
    PUGL_VK_KP_Equals = 103,
    PUGL_VK_F13 = 104,
    PUGL_VK_F14 = 105,
    PUGL_VK_F15 = 106,
    PUGL_VK_F16 = 107,
    ...
    PUGL_VK_SysReq = 154,
    PUGL_VK_Return = 158,
    PUGL_VK_KP_Clear = 216,
    PUGL_VK_KP_Decimal = 220,
    PUGL_VK_LeftControl = 224,
    PUGL_VK_LeftShift = 225,
    PUGL_VK_LeftAlt = 226,
    PUGL_VK_LeftGUI = 227,
    PUGL_VK_RightControl = 228,
    PUGL_VK_RightShift = 229,
    PUGL_VK_RightAlt = 230,
    PUGL_VK_RightGUI = 231
} PuglKeyCodes;
